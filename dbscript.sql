...
create table IF NOT EXISTS employee(employee_id INT GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS manager(manager_id INT GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS pending_reimbursment(
...
CREATE TABLE IF NOT EXISTS resolved_reimbursment(
   									reimbursement_id INT GENERATED ALWAYS AS IDENTITY,
   									requesting_employee_id INT,		
   									reimbursement_amount double precision,
